...
export class ReporteTiendasComponent implements OnInit {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/tienda_pendiente_cl")
    .subscribe((data: any) => {
      this.tiendasPendientes=data;
    });

    this.http.get("http://192.168.84.108:8080/servicios/tiendas_fecha_cl")
    .subscribe((data: any) => {
      this.tiendasPendientesFecha=data;
    });

    this.http.get("http://192.168.84.108:8080/servicios/pedido_cerrar_cl/")
    .subscribe((data: any) => {
      console.log(data)
      this.pedidosPorCerrar=data;
    });

    /*this.http.get("http://192.168.84.108:8080/servicios/pedido_sin_tr_cl/")
    .subscribe((data: any) => {
      console.log(data)
  ...
  actualizarTiendasPendienes()
  {
    ...
    this.http.get("http://192.168.84.108:8080/servicios/update_tablas_tienda_cl/").subscribe((data: any) =>
    {
      this.http.get("http://192.168.84.108:8080/servicios/tienda_pendiente_cl").subscribe((data: any) =>
      {
        this.tiendasPendientes=data;
      });

      this.http.get("http://192.168.84.108:8080/servicios/tiendas_fecha_cl").subscribe((data: any) =>
      {
        this.tiendasPendientesFecha=data;
      });

      this.http.get("http://192.168.84.108:8080/servicios/pedido_cerrar_cl/").subscribe((data: any) =>
      {
        this.pedidosPorCerrar=data;
      });

      /*this.http.get("http://192.168.84.108:8080/servicios/pedido_sin_tr_cl/").subscribe((data: any) =>
      {
        this.infoPedidosSinTr=data;
      });*/
  ...
  enviarCorreos(){
    this.http.get("http://192.168.84.108:8080/servicios/envio_correos_cl/")
    .subscribe((data: any) => {
    });
  }

  cerrarPedidos(){
    this.http.get("http://192.168.84.108:8080/servicios/cerrar_pedidos_cl/")
    .subscribe((data: any) => {
    });
  }
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/insert_fecha_trafico_cl/"+fecha+"/"+carga+"/"+pedido+"/")
    .subscribe((data: any) => {
      this.http.get("http://192.168.84.108:8080/servicios/tiendas_fecha_cl")
      .subscribe((data: any) => {
        this.tiendasPendientesFecha=data;
  ...
  {
    let url: string="http://192.168.84.108:8080/servicios/pedido_tienda_cl/";
  ...
  {
    let url: string="http://192.168.84.108:8080/servicios/detalle_pedido_tienda_cl/";
  ...
  {
    let url: string="http://192.168.84.108:8080/servicios/detalle_pedido_tienda_file_cl/";
  ...
  {
    let url: string="http://192.168.84.108:8080/servicios/solicitud_traslado_cl/";
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/tabla_tiendas_cl/"+fecha).subscribe((data: any) =>
    {
