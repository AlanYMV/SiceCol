...
export class CuadrajeComponent implements OnInit {
  ...
  { 
    this.http.get("http://192.168.84.108:8080/servicios/cuadraje_cl/")
    .subscribe((data: any) => {
      this.cuadrajes=data;
    ...
    this.http.get("http://192.168.84.108:8080/servicios/pendiente_semana_cl/")
    .subscribe((data: any) => {
  ...
  actualizarCuadraje()
  {
    ...
    this.http.get("http://192.168.84.108:8080/servicios/execute_cuadraje_cl/")
    .subscribe((data: any) => 
    {
      this.http.get("http://192.168.84.108:8080/servicios/cuadraje_cl/")
      .subscribe((data: any) => {
  ...
  actualizardiferencias()
  {
    ...
    this.http.get("http://192.168.84.108:8080/servicios/update_diferencias_cl/")
    .subscribe((data: any) => 
    {
      this.http.get("http://192.168.84.108:8080/servicios/cuadraje_cl/")
      .subscribe((data: any) => {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/recibo_sap_valor_cl/"+tipoDiferenciaRecibo)
    .subscribe((data: any) => {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/pedido_sap_valor_cl/"+tipoDiferenciaPedido)
    .subscribe((data: any) => {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/recibo_sap_cl/"+recibos)
    .subscribe((data: any) => {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/pedido_sap_cl/"+pedidos)
    .subscribe((data: any) => {
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/insert_sapreceipt_cl/"+idReceipt)
    .subscribe((data: any) => {
      this.pedidosSapAjustes=data;
    });
  }
  ...
  {
    this.http.get("http://192.168.84.108:8080/servicios/insert_sapshipment_cl/"+idShipment)
    .subscribe((data: any) => {
      this.pedidosSapAjustes=data;
    });
  }
